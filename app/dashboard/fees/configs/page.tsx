...
export default function BillingConfigsPage() {
  ...
  return (
    <div className="space-y-6 font-sans">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight flex items-center space-x-2">
            ...
            <span>Billing & Fees Configs</span>
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Configure invoice categories and bulk allocate monthly tuition fees</p>
        </div>
      ...
      {loading ? (
        <div className="text-center py-12 text-slate-400">Loading billing configurations...</div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex justify-between items-center bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 rounded-2xl p-4 sm:p-6 shadow-sm">
              <div className="w-full space-y-4">
                <div className="flex justify-between items-center border-b pb-3 border-slate-100 dark:border-slate-800">
                  <h3 className="font-bold text-slate-800 dark:text-slate-200 text-base">Fee Billing Categories</h3>
                  <Button
                  ...
                  {categories.length === 0 ? (
                    ...
                    categories.map((cat) => (
                      <div key={cat._id} className="flex justify-between items-center bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl p-3 shadow-xs">
                        <div>
                          <p className="text-sm font-bold text-slate-850 dark:text-slate-200">{cat.name}</p>
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 rounded-2xl p-4 sm:p-6 shadow-sm space-y-4">
              <div className="flex justify-between items-center border-b pb-3 border-slate-100 dark:border-slate-800">
                <h3 className="font-bold text-slate-800 dark:text-slate-200 text-base">Allocate Fees to Class</h3>
                <Button
              ...
              {showAllocationForm && (
                <form onSubmit={handleTriggerAllocation} className="bg-slate-50 dark:bg-slate-955/25 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 space-y-4 animate-in fade-in duration-200">
                  ...
                  <div className="flex space-x-2 pt-2 border-t border-slate-100 dark:border-slate-800 pt-3">
                    <Button type="submit" className="bg-indigo-650 hover:bg-indigo-700 text-white font-medium px-4 py-2 rounded-xl text-xs">
                      Trigger Allocations
                    </Button>
                    <Button
                      ...
                      className="bg-slate-100 hover:bg-slate-250 dark:bg-slate-800 dark:text-slate-350 font-medium px-4 py-2 rounded-xl text-xs"
                    >
                      Cancel
                    </Button>
                  </div>
