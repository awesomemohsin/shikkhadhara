    ...
    <div className="space-y-6 font-sans">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1 text-sm">Process manual and digital payment collections from student registers</p>
        </div>

        <div>
          <Button
            onClick={() => router.push('/dashboard/fees/due')}
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/80 rounded-3xl p-6 sm:p-8 shadow-sm">
        {loading ? (
          ...
          <form onSubmit={handleRecordPayment} className="space-y-4">
            <h3 className="font-bold text-slate-800 dark:text-slate-250 text-sm">Record Student Fee Collection</h3>
            <div>
            ...
            <div className="flex space-x-2 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <Button
                type="button"
                onClick={() => router.push('/dashboard/fees/due')}
                className="bg-slate-100 hover:bg-slate-200 text-slate-650 dark:bg-slate-800 dark:text-slate-300 font-medium px-6 py-2.5 rounded-xl"
              >
                Cancel
              </Button>
            </div>
